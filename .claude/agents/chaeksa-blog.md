...
- 책사 궁합 시리즈(09-25 사장님): 이름은 「책사 궁합」. 띠 · 이름 · MBTI · 생년월일 궁합은 「반쪽」이라고 주장하는 게 우리 입장(두 사람 여덟 글자, 일지 · 식상을 봐야 온전). 여섯 편이 아니라 조합으로 수백 편 — 띠 궁합 78쌍 · 일주 60 · 닿음 50 · 단계 질문 31 · 반쪽 시리즈 · 속궁합/결혼. 글 끝은 연애궁합 웹툰(?from=blog-gh-…).

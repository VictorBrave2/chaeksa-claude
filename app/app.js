...
(function () {
  ...
  function renderChong() {
    ...
    const 특 = [
      ...
      ['실간명 채점, 문항 적중 90%', '이 엔진의 간명을 실제 인물이 문항별로 채점했습니다 — 20문 중 18문 적중. 곧 나올 당신의 간명서도 문항마다 [맞다/아니다]로 직접 채점하실 수 있습니다. 빗나간 것도 숨기지 않습니다.'],
  ...
  const GM_VER = 'v8';   // v8: 제25·26조 — 인성=근거, 운의 천간=깨달음/지지=행동
  const 간명키 = () => {

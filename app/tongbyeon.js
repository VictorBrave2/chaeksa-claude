  ...
  R('career','관성','mid',{
    ...
    H:[
      ...
      H('strain','맡을 수는 있으나 조건을 안 걸면 그대로 소모된다',.45,
        '버틸 수 있다는 뜻이지 남는다는 뜻이 아닙니다. 조건 없이 받으면 감당은 되는데 남는 것이 없는 형태로 굳기 쉽습니다.',
  ...
  R('career','재성','mid',{
    ...
    H:[
      ...
      H('friction','벌리기는 하는데 회수가 늦어 다음이 막힌다',.45,
        '힘이 모자라서가 아니라 벌린 것이 돌아오는 주기가 길어서 생기는 정체입니다. 과부하보다 이 마찰에서 발이 묶입니다.',
  ...
  R('career','식상','mid',{
    ...
    H:[
      H('newline','새로 시작한 갈래 하나가 본류가 된다',.55,
        '식상이 들어오는데 일간이 이를 감당할 만큼은 되어, 벌린 것 중 하나가 뿌리를 내립니다. 이 흐름이 가장 잘 붙습니다.',
      ...
      H('scatter','여러 갈래로 벌어져 어느 것도 임계에 못 간다',.45,
        '힘이 모자란 것이 아니라 고르게 나뉘어서 생기는 문제입니다. 어느 쪽도 못 버릴 만큼 다 할 만해 보여서 오히려 흩어집니다.',
  ...
  R('career','인성','mid',{
    ...
    H:[
      ...
      H('stall','준비만 길어지고 실전이 미뤄진다',.48,
        '인성 과다는 아니지만, 준비가 편안하기 때문에 실전으로 넘어갈 이유를 못 찾는 정체가 생깁니다.',

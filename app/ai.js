...
${prof}` : ''}`;
  ...
  const 간명본보기 = '[본보기 간명 전문 — 이 밀도·리듬·따뜻함 그대로. 실제 채점 90%를 받은 글이다]\n'
    + '壬申 己酉 辛亥 丙申 — 가을 바위산의 보석이 바다를 안고 있는 사주네요. 갑니다.\n'
    + '[구조]\n'
    + '① 辛금이 유월 — 건록을 얻고 신강, 금이 넷인 단단한 사주입니다. 그 힘을 연간 壬 상관이 바다로 흘립니다 — 금수상관: 머리가 차갑게 좋고, 말이 정확하고, 미적 감각이 있는 총명 구조입니다.\n'
    + '② 시간에 丙 정관 — 금수상관이 관을 반기는 배치라, 똑똑한데 조직도 되는 드문 조합입니다. 丙이 이 사주의 기둥입니다.\n'
    + '③ 다만 월간 己 편인이 壬 상관 곁에 — 맑게 흐를 총명함이 의심과 궁리로 탁해지는 순간이 있습니다. 생각이 많아 스스로 발목을 잡는 날이 있었을 겁니다.\n'
    + '[성격]\n'
    + '④ 보석 辛 — 깔끔하고 예리하고 자기 관리가 철저합니다. 대충을 못 견디고, 말은 적지만 나오면 정확해서 가끔 칼이 됩니다.\n'
    + '[재물의 결]\n'
    + '⑤ 재성 목이 원국에 0 — 무재 사주입니다. 못 버는 게 아니라 운이 데려오는 구조고, 버는 길은 상관생재 — 기술과 실력이 돈이 되는 길입니다.\n'
    + '⑥ 2022년부터 2025년까지는 벌이의 띠였습니다 — 이 사이 수입이 눈에 띄게 늘었다면, 이 계산이 맞게 가고 있는 것입니다.\n'
    + '[연애 — 구조]\n'
    + '⑦ 당신은 음(陰)의 기운을 타고난 남성 — 인연의 글자와 일간이 손을 맞잡는 합이 아닌 사주입니다. 온 인연이 오래 머물지 않던 데엔 이런 구조적 이유가 있었습니다.\n'
    + '⑧ 그런데 방은 좋습니다. 배우자 방 亥에서 甲이 장생 — 방 자체는 사람을 살리는 방입니다. 방은 준비돼 있는데 문이 막힌 집 — 이 사주의 연애를 한 줄로 하면 이겁니다.\n'
    + '⑨ 방에 앉은 壬이 하늘에도 떠 있어 회전문입니다 — 丁의 사람은 들어왔다 나가기를 반복합니다. 이 회전문을 타지 않는 유일한 글자는 乙 — 부드럽고 사교적이며 어디서든 타고 오르는 생활력의 사람이, 이 방을 끝내 지킵니다.\n'
    + '[연애 — 지나온 자리]\n'
    + '⑩ 2015년 — 온전한 통로 乙이 하늘에 온 해입니다. 인연의 축이 크게 돌았기 쉽습니다. 시작이었든, 굳었든, 틀어졌든 — 어느 쪽이었는지는 당신이 아십니다.\n'
    + '[앞으로]\n'
    + '⑪ 정공법은 乙의 사람입니다. 그리고 크게는 甲寅 대운, 2034년부터 — 없던 재성이 뿌리째 들어오는 10년입니다. 결혼이 늦느냐 물으신다면, 늦는 게 아니라 본론이 그쪽에 놓여 있는 사주라 답하겠습니다.';
  async function ganmyeong(facts, cachePk) {
    const sys = '너는 사주명리 비서 「책사」의 간명가다. 지금 쓰는 것은 결제한 사용자의 **간명서** — 번호 문항으로 이 사람을 통변하고, 사용자가 문항마다 맞다/아니다로 채점하는 문서다.\n'
      ...
      + '- 말투는 곁에 앉은 노련한 명리가다: 따뜻하고 유려한 존댓말, 상투적 위로 금지, 보고서체·상담봇체 금지.\n'

...
(function (global) {
  ...
  // ── 기억 — 비서가 한 말과 그에 대한 답 (docs/29 넷) ──
  //
  // 「기억합니다」는 랜딩의 약속인데 화면 어디에도 기억하는 장면이 없었다.
  ...
  global.ChaeksaMemo = { list, add, setOutcome, remove, due, upcoming, stats, judge, label, OUTCOMES, ym,
                         track, tracks, log, loggedThisMonth, pattern, respond, standing, said, toAsk, answer, lastAnswered };
})(window);

...
(function (global) {
  ...
  function 사람(R, today) {
    ...
    const 바뀜전부 = 대운.filter(d => d.격 !== 격 && !d.늦음), 올해0 = (today || new Date()).getFullYear();
    ...
    const 돌아옴0 = 지금대운 && 지금대운.격 !== 격 ? (대운.slice(지금i + 1).find(d => d.격 === 격) || null) : null, 돌아옴 = 돌아옴0 && !돌아옴0.늦음 ? 돌아옴0 : null;

...
(function (global) {
  ...
  function 그리기(box, input) {
    ...
    const 통설주 = '<p class="jt-yet">「~다고들 해요」로 적은 줄은 고전이 아니라 요즘 명리가들이 두루 하는 말이에요. 여러 곳이 같게 말하는 것만 실었어요. 「많다」는 나 말고 ' + (시없음 ? '다섯 글자 가운데 셋 이상일 때예요. 태어난 시간을 몰라서 시주 두 글자를 뺀 여섯 글자로 셌어요.' : '일곱 글자 가운데 셋 이상일 때예요.') + '</p>';
    if (YY) {

...
PAGES = ['index.html', 'pay.html', 'pay-done.html', 'pay-fail.html', 'taekil.html', 'taekil-apply.html', 'taekil-sim.html', 'myeongsik.html', 'jeongtong.html', 'gunghap-chongnon.html', 'ssom.html']
pages, tagged = {}, 0
for pg in PAGES:
